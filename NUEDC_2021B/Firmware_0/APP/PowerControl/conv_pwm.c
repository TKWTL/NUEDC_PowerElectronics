...
void Timer_Init(ui_t *ui){
    ...
    //需要实测得出
    LL_HRTIM_TIM_SetCompare4(HRTIM1, LL_HRTIM_TIMER_A, 9100);
    LL_HRTIM_TIM_SetCompare3(HRTIM1, LL_HRTIM_TIMER_B, 7200);
    LL_HRTIM_TIM_SetCompare4(HRTIM1, LL_HRTIM_TIMER_C, 7910);
    LL_HRTIM_TIM_SetCompare3(HRTIM1, LL_HRTIM_TIMER_D, 7200);
