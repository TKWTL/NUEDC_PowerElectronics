...
RAMVAR PowerControlVar_t 
    ...
    IA_t  = {ADC4_Buffer, 0, 7.5057f, -11.8869f, 0},//整流器A相输入电流，单位A，输入->半桥为负
    //整流器B相输入电流省略不接
    IC_t  = {ADC2_Buffer, 0, 7.6081f, -12.1131f, 0},//整流器C相输入电流，单位A，输入->半桥为负
    ...
    IN_t  = {ADC1_Buffer, 0, 7.5052f, -11.9725f, 0},//BUCK电感电流，单位A，半桥->输出为正
